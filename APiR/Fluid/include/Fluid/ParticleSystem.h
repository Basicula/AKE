...
inline auto ParticleSystem::_BeginVectorDataAt(std::size_t i_index) const -> ParticleSystem::VectorDataIteratorC
{
  return m_vector_data[i_index].cbegin();
}

inline auto ParticleSystem::_EndVectorDataAt(std::size_t i_index) const -> ParticleSystem::VectorDataIteratorC
{
  return m_vector_data[i_index].cend();
}

inline auto ParticleSystem::_BeginVectorDataAt(std::size_t i_index) -> ParticleSystem::VectorDataIterator
{
  return m_vector_data[i_index].begin();
}

inline auto ParticleSystem::_EndVectorDataAt(std::size_t i_index) -> ParticleSystem::VectorDataIterator
{
  return m_vector_data[i_index].end();
}

inline auto ParticleSystem::_BeginScalarDataAt(std::size_t i_index) const -> ParticleSystem::ScalarDataIteratorC
{
  return m_scalar_data[i_index].cbegin();
}

inline auto ParticleSystem::_EndScalarDataAt(std::size_t i_index) const -> ParticleSystem::ScalarDataIteratorC
{
  return m_scalar_data[i_index].cend();
}

inline auto ParticleSystem::_BeginScalarDataAt(std::size_t i_index) -> ParticleSystem::ScalarDataIterator
{
  return m_scalar_data[i_index].begin();
}

inline auto ParticleSystem::_EndScalarDataAt(std::size_t i_index) -> ParticleSystem::ScalarDataIterator
{
  return m_scalar_data[i_index].begin();
}