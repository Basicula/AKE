...
void Transformation::SetRotation(const Vector3d& i_axis, double i_degree_in_rad)
{
  ...
  m_rotation = Matrix3d{ cosine + ux * ux * one_minus_cos,    ux * uy * one_minus_cos - uz * sine,
