...
class TestImageProperties(unittest.TestCase):
    ...
    def test_image_rgb_str_data(self):
        ...
        self.assertEqual(image_rgb_str_data[3], chr(0xff))
        
        self.assertEqual(image_rgb_str_data, (chr(0x12) + chr(0x34) + chr(0x56) + chr(0xff)) * image.size)
