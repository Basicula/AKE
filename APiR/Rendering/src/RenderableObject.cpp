...
RenderableObject::RenderableObject(ISurface* i_surface, IVisualMaterial* i_material)
  : Object()
...
bool RenderableObject::IntersectWithRay(double& o_distance, const Ray& i_ray, const double i_far) const
{
