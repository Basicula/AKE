...
TEST(ThreadPoolTest, ThreadPoolCommonScenario)
{
  ...
  for (auto k : { 1, 2, 4, 8 }) {
    ...
    auto time = function_wrapper_for_time(
      [&]() {
...
TEST(ThreadPoolTest, ThreadPoolParallelFor)
{
  ...
  auto common_time = function_wrapper_for_time(
    [&]() {
  ...
  auto parallel_for_time = function_wrapper_for_time(
    [&]() {
  ...
  auto parallel_for_in_parallel_for_time = function_wrapper_for_time(
    [&]() {
      pool->ParallelFor(static_cast<std::size_t>(0), n, [&](std::size_t i) {
