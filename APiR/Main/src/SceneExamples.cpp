...
namespace ExampleScene {
  ...
  Scene EmptyRoom() {
    ...
    scene.AddObject(new RenderableObject(new Plane(Vector3d(0, 0, 10), Vector3d(0, 0, -1)), ExampleMaterials::blue_plastic()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(10, 0, 0), Vector3d(-1, 0, 0)), ExampleMaterials::red_plastic()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(-10, 0, 0), Vector3d(1, 0, 0)), ExampleMaterials::green_plastic()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(0, -10, 0), Vector3d(0, 1, 0)), ExampleMaterials::yellow_plastic()));
  ...
  Scene ComplexScene() {
    ...
    scene.AddObject(new RenderableObject(new Plane(Vector3d(0, 0, 10), Vector3d(0, 0, -1)), ExampleMaterials::blue_plastic()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(10, 0, 0), Vector3d(-1, 0, 0)), ExampleMaterials::pure_mirror()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(-10, 0, 0), Vector3d(1, 0, 0)), ExampleMaterials::green_plastic()));
    scene.AddObject(new RenderableObject(new Plane(Vector3d(0, -10, 0), Vector3d(0, 1, 0)), ExampleMaterials::yellow_plastic()));
