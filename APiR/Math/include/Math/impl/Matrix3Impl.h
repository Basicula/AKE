...
void Matrix3<ElementType>::ApplyLeft(Vector3d& io_vector) const
  {
  const double x =
    m_matrix[0][0] * io_vector[0] +
    m_matrix[0][1] * io_vector[1] +
    m_matrix[0][2] * io_vector[2];
  const double y =
    m_matrix[1][0] * io_vector[0] +
    m_matrix[1][1] * io_vector[1] +
    m_matrix[1][2] * io_vector[2];
  const double z =
    m_matrix[2][0] * io_vector[0] +
    m_matrix[2][1] * io_vector[1] +
    m_matrix[2][2] * io_vector[2];
...
void Matrix3<ElementType>::ApplyRight(Vector3d& io_vector) const
  {
  const double x =
    m_elements[0] * io_vector[0] +
    m_elements[3] * io_vector[1] +
    m_elements[6] * io_vector[2];
  const double y =
    m_elements[1] * io_vector[0] +
    m_elements[4] * io_vector[1] +
    m_elements[7] * io_vector[2];
  const double z =
    m_elements[2] * io_vector[0] +
    m_elements[5] * io_vector[1] +
    m_elements[8] * io_vector[2];
