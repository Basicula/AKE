...
template <class ElementType, std::size_t Dimension>
template <std::size_t D, typename T>
inline Vector<ElementType, Dimension>::Vector(ElementType i_x, ElementType i_y, ElementType i_z)
  : m_coords{ i_x, i_y, i_z }
{}

template <class ElementType, std::size_t Dimension>
template <std::size_t D, typename T>
inline Vector<ElementType, Dimension>::Vector(ElementType i_x, ElementType i_y, ElementType i_z, ElementType i_w)
...
template <class ElementType, std::size_t Dimension>
inline const ElementType& Vector<ElementType, Dimension>::operator[](std::size_t i_index) const
{
  return m_coords[i_index];
}
...
template <class ElementType, std::size_t Dimension>
Vector<ElementType, Dimension> Vector<ElementType, Dimension>::operator-(
...
template <class ElementType, std::size_t Dimension>
Vector<ElementType, Dimension>& Vector<ElementType, Dimension>::operator-=(
  const Vector<ElementType, Dimension>& i_other)
{
...
template <class ElementType, std::size_t Dimension>
template <std::size_t D, typename T>
Vector<ElementType, Dimension> Vector<ElementType, Dimension>::CrossProduct(
  const Vector<ElementType, Dimension>& i_other) const
{
