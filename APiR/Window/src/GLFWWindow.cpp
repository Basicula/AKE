...
namespace {
  ...
  MouseButton GLFWIntToMouseButton(const int i_button)
  {
    switch (i_button) {
      case 0:
        return MouseButton::MOUSE_LEFT_BUTTON;
      case 1:
        return MouseButton::MOUSE_RIGHT_BUTTON;
      case 2:
        return MouseButton::MOUSE_MIDDLE_BUTTON;
      default:
        return MouseButton::MOUSE_UNDEFINED_BUTTON;
    }
  }
  ...
  KeyboardButton GLFWIntToKeyboardButton(const int i_key)
  {
    switch (i_key) {
      case GLFW_KEY_Q:
        return KeyboardButton::KEY_Q;
      case GLFW_KEY_W:
        return KeyboardButton::KEY_W;
      case GLFW_KEY_E:
        return KeyboardButton::KEY_E;
      case GLFW_KEY_R:
        return KeyboardButton::KEY_R;
      case GLFW_KEY_T:
        return KeyboardButton::KEY_T;
      case GLFW_KEY_Y:
        return KeyboardButton::KEY_Y;
      case GLFW_KEY_U:
        return KeyboardButton::KEY_U;
      case GLFW_KEY_I:
        return KeyboardButton::KEY_I;
      case GLFW_KEY_O:
        return KeyboardButton::KEY_O;
      case GLFW_KEY_P:
        return KeyboardButton::KEY_P;
      case GLFW_KEY_A:
        return KeyboardButton::KEY_A;
      case GLFW_KEY_S:
        return KeyboardButton::KEY_S;
      case GLFW_KEY_D:
        return KeyboardButton::KEY_D;
      case GLFW_KEY_F:
        return KeyboardButton::KEY_F;
      case GLFW_KEY_G:
        return KeyboardButton::KEY_G;
      case GLFW_KEY_H:
        return KeyboardButton::KEY_H;
      case GLFW_KEY_J:
        return KeyboardButton::KEY_J;
      case GLFW_KEY_K:
        return KeyboardButton::KEY_K;
      case GLFW_KEY_L:
        return KeyboardButton::KEY_L;
      case GLFW_KEY_Z:
        return KeyboardButton::KEY_Z;
      case GLFW_KEY_X:
        return KeyboardButton::KEY_X;
      case GLFW_KEY_C:
        return KeyboardButton::KEY_C;
      case GLFW_KEY_V:
        return KeyboardButton::KEY_V;
      case GLFW_KEY_B:
        return KeyboardButton::KEY_B;
      case GLFW_KEY_N:
        return KeyboardButton::KEY_N;
      case GLFW_KEY_M:
        return KeyboardButton::KEY_M;
      case GLFW_KEY_1:
      ...
      default:
        return KeyboardButton::KEY_UNDEFINED;
    }
  }
}
...
void GLFWWindow::_MouseButtonCallback(GLFWwindow* /*ip_window*/,
                                      const int i_button,
                                      const int i_action,
                                      const int /*i_mods*/)
{
...
void GLFWWindow::_KeyboardCallback(GLFWwindow* /*ip_window*/,
                                   const int i_key,
                                   const int /*i_scancode*/,
                                   const int i_action,
                                   const int /*i_mods*/)
{
