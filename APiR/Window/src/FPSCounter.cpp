...
FPSCounter::FPSCounter(std::ostream& io_output_stream, std::size_t i_update_interval_in_frames)
...
FPSCounter::FPSCounter(std::size_t i_update_interval_in_frames, std::function<void(double)> i_fps_logging_function)
  : m_start(std::chrono::system_clock::now())
  , m_frames_cnt(0)
  , m_update_interval(i_update_interval_in_frames)
