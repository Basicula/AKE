...
{
public:
  PhongMaterial(const Color& i_color = Color(0xffaaaaaa),
  ...
  virtual Color CalculateColor(const Vector3d& i_normal,
                               const Vector3d& i_view_direction,
                               const Vector3d& i_light_direction) const override;

  virtual bool IsReflectable() const override;
  virtual Vector3d ReflectedDirection(const Vector3d& i_normal_at_point,
